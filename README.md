...
![Copilot subscription status interface](./pic/usage.png)
...
![Copilot Chat models selection interface](./pic/models.png)
7. 你可以从本地 Copilot Agent 切换到由 Claude 或 Codex 提供的 Agent
![Copilot Agent selection interface](./pic/agents.png)
